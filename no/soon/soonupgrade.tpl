...
<div id="contract" class="contract contractNew contractWrapper">
	...
	<div class="contractLink">
		...
		?>
        <span class="buildingCondition"><a href="#" onclick="return Travian.Game.iPopup(15,4, 'gid');">Main Building</a> <span title="+2">Level 3</span>, <a href="#" onclick="return Travian.Game.iPopup(10,4, 'gid');">Warehouse</a> <span title="+1">Level 1</span>, <a href="#" onclick="return Travian.Game.iPopup(11,4, 'gid');">Granary</a> <span title="+1">Level 1</span></span>
        <?php
            } else if($bid == 18) {
		?>
        <span class="buildingCondition"></span>
