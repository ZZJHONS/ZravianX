...
# New translation version #
	...
	$lang['build11_desc'] = "Granary";
	$lang['build12'] = "Blacksmith";
	$lang['build12_desc'] = "Blacksmith";
	$lang['build13'] = "Armoury";
	$lang['build13_desc'] = "Armoury";
	$lang['build14'] = "Tournament Square";
	$lang['build14_desc'] = "Tournament Square";
	$lang['build15'] = "Main Building";
	$lang['build15_desc'] = "Main Building";
	$lang['build16'] = "Rally Point";
	$lang['build16_desc'] = "Rally Point";
	$lang['build17'] = "Marketplace";
	$lang['build17_desc'] = "Marketplace";
	$lang['build18'] = "Embassy";
	$lang['build18_desc'] = "Embassy";
	$lang['build19'] = "Barracks";
	$lang['build19_desc'] = "Barracks";
	$lang['build20'] = "Stable";
	$lang['build20_desc'] = "Stable";
	$lang['build21'] = "Workshop";
	$lang['build21_desc'] = "Workshop";
	$lang['build22'] = "Academy";
	$lang['build22_desc'] = "Academy";
	$lang['build23'] = "Cranny";
	$lang['build23_desc'] = "Cranny";
	$lang['build24'] = "Town Hall";
	$lang['build24_desc'] = "Town Hall";
	$lang['build25'] = "Residence";
	$lang['build25_desc'] = "Residence";
	$lang['build26'] = "Palace";
	$lang['build26_desc'] = "Palace";
	$lang['build27'] = "Treasury";
	$lang['build27_desc'] = "Treasury";
	$lang['build28'] = "Trade Office";
	$lang['build28_desc'] = "Trade Office";
	$lang['build29'] = "Great Barracks";
	$lang['build29_desc'] = "Great Barracks";
	$lang['build30'] = "Great Stable";
	$lang['build30_desc'] = "Great Stable";
	$lang['build31'] = "City Wall";
	$lang['build31_desc'] = "City Wall";
	$lang['build32'] = "Earth Wall";
	$lang['build32_desc'] = "Earth Wall";
	$lang['build33'] = "Palisade";
	$lang['build33_desc'] = "Palisade";
	$lang['build34'] = "Stonemason's Lodge";
	$lang['build34_desc'] = "Stonemason's Lodge";
	$lang['build35'] = "Brewery";
	$lang['build35_desc'] = "Brewery";
	$lang['build36'] = "Trapper";
	$lang['build36_desc'] = "Trapper";
	$lang['build37'] = "Hero's Mansion";
	$lang['build37_desc'] = "Hero's Mansion";
	$lang['build38'] = "Great Warehouse";
	$lang['build38_desc'] = "Great Warehouse";
	$lang['build39'] = "Great Granary";
	$lang['build39_desc'] = "Great Granary";
	$lang['build40'] = "Wonder of the World";
	$lang['build40_desc'] = "Wonder of the World";
	$lang['build41'] = "Horse Drinking Trough";
	$lang['build41_desc'] = "Horse Drinking Trough";
