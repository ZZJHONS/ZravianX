...
.jScroll .jScroll-element-down {background: transparent url(http://ts1.travian.us/crypt.js?1314084856images/down.gif) no-repeat center bottom; height: 6px;}
.jScroll .jScroll-element-down:hover {background-image: url(http://ts1.travian.us/crypt.js?1314084856images/down-hover.gif);}
.jScroll .jScroll-element-up {background: transparent url(http://ts1.travian.us/crypt.js?1314084856images/up.gif) no-repeat center top; height: 6px;}
.jScroll .jScroll-element-up:hover {background-image: url(http://ts1.travian.us/crypt.js?1314084856images/up-hover.gif);}
...
.jScroll .jScroll-element-slider .top {background: transparent url(http://ts1.travian.us/crypt.js?1314084856images/slider-top.gif) no-repeat center top; height: 1px;}
.jScroll .jScroll-element-slider:hover .top {background-image: url(http://ts1.travian.us/crypt.js?1314084856images/slider-top-hover.gif);}
.jScroll .jScroll-element-slider .center {background: transparent url(http://ts1.travian.us/crypt.js?1314084856images/slider-center.gif) repeat-y center top;}
.jScroll .jScroll-element-slider:hover .center {background-image: url(http://ts1.travian.us/crypt.js?1314084856images/slider-center-hover.gif);}
.jScroll .jScroll-element-slider .bottom {background: transparent url(http://ts1.travian.us/crypt.js?1314084856images/slider-bottom.gif) no-repeat center bottom; height: 1px;}
.jScroll .jScroll-element-slider:hover .bottom {background-image: url(http://ts1.travian.us/crypt.js?1314084856images/slider-bottom-hover.gif);}
</style>
...
Travian.Game.worldId = 'us11';
    ...
    <body class="v35 gecko build gidRessources">
                    <div id="wrapper">
...
<div id="mid">  <a id="ingameManual" href="help.php">
