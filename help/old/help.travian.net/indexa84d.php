...
<!-- Mirrored from help.travian.net/index.php?type=report&pt=faq&pm=342 by HTTrack Website Copier/3.x [XR&CO'2010], Thu, 03 Feb 2011 12:43:16 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8"><!-- /Added by HTTrack -->
<head>
	<title>Travian - Juego de Navegador - FAQ - Informar de un error</title>
...
<body onload="start()">
		...
		<div id="lmidlc">
			<div id="lleft">
				...
				<div id="lmenu">
					<ul id="navbox">
						...
						<li><a class="treenode" href="index987d.html?type=faq&amp;mod=200">Tutoriales</a></li>
			...
			<div id="lmid1">
				<div id="lmid2">
					<div class="headline"><img src="img/anleitung.png" alt="Head" width="468" height="60" border="0"/></div>
						<div class="wholebox">
							<form action="http://help.travian.net/index.php?type=report&amp;mod=1000&amp;sent" method="post">
								<h1>Informar de un error</h1>
								<p>Este recuadro blanco le permitirá reportar errores a los creadores de esta página web para poder corregirlos.<br />Los datos que usted quiera reportar se adjuntarán automáticamente al reporte. Sólo tiene que poner su nombre, una dirección de correo electrónico y la mejora propuesta.</p>
								<table class="p1" style="width:100%" cellspacing="1" cellpadding="0">
								<tr><td>
								<table width="100%" cellspacing="1" cellpadding="0" class="report">
								<tr><td><label>Su nombre:</label><input class="fm fm300" type="text" name="name" value="" maxlength="20" /></td></tr>
								<tr><td><label>E-Mail:</label><input class="fm fm300" type="text" name="email" value="" maxlength="50" /></td></tr>
								<tr><td><label>Localización del Error:</label><input class="fm fm300" type="text" name="location" value="index.php?type=faq&amp;mod=342" maxlength="100" /></td></tr>
								<tr><td><label>Mejora:</label><textarea name="improvement" rows="100" cols="50" style="width:300px; height: 150px;"></textarea></td></tr>
								</table>
								</td></tr>
								</table>
								<p style="text-align: center;"><input name="ip" type="hidden" value="90.168.77.140" /><input class="button send" type="image" src="img/x.gif" name="send" value="send" alt="Enviar" title="Enviar" /></p>
							</form>
						</div>
					</div>
				</div>
			...
			<div id="lright1">
				...
				<div class="rbox">
					...
					<div class="dashed">
						<form action="http://help.travian.net/index.php?type=report&amp;mod=1000" method="post">
	...
	<div id="lfooter1">
		<div id="lfooter2">
			<a class="clink" href="index942a.html?type=report&amp;pt=report&amp;pm=1000">Informar de un error</a> |
