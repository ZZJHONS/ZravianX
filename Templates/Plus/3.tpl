...
<table class="plusFunctions" cellpadding="1" cellspacing="1">
    ...
    <tbody>
		<tr>
			...
			<td class="desc">
				<b><font color="#71D000">P</font><font color="#FF6F0F">l</font><font color="#71D000">u</font><font color="#FF6F0F">s</font></b> Account
                <br />
                <span class="run"> 
                    <?php 
			...
			<td class="cost"><img src="img/x.gif" class="gold" alt="Gold" title="Gold" alt="Gold" title="Gold" />9.99</td>
			<td class="act">
				<?php
                    $MyGold = mysql_query("SELECT * FROM ".TB_PREFIX."users WHERE `username`='".$session->username."'") or die(mysql_error());
                    $golds = mysql_fetch_array($MyGold);
                    ...
                    if (mysql_num_rows($MyGold)) {
                        ...
                        echo '<a href="plus.php?id=8"><span>Activate';
                    }elseif
                        ($golds['gold'] > 9 && $datetimep > $date2) {
                        echo '<a href="plus.php?id=8"><span>Extend';
                    } else {
		...
		<tr>
			...
			<td class="desc">
				+<b>25</b>% <img class="r1" src="img/x.gif" alt="Lumber" title="Lumber" /> Production: Lumber
                <br />
				<span class="run">
					<?php
						$tl_b1=$golds['b1'];
			...
			<td class="cost"><img src="img/x.gif" class="gold" alt="Gold" title="Gold" />4.99</td>
			<td class="act">
            	<span class="none">
					<?php
						if (mysql_num_rows($MyGold)) {
		...
		<tr>
			...
			<td class="desc">
				+<b>25</b>% <img class="r2" src="img/x.gif" alt="Clay" title="Clay" /> Production: Clay
                <br />
				<span class="run">
					<?php
						$tl_b2=$golds['b2'];
		...
		<tr>
			...
			<td class="desc">
				+<b>25</b>% <img class="r3" src="img/x.gif" alt="Iron" title="Iron" /> Production: Iron
                <br />
				<span class="run">
					<?php
                        $tl_b3=$golds['b3'];
		...
		<tr>
			...
			<td class="desc">
				+<b>25</b>% <img class="r4" src="img/x.gif" alt="Crop" title="Crop" /> Production: Crop
                <br />
				<span class="run">
					<?php
                        $tl_b4=$golds['b4'];
		...
		<tr>
			...
			<td class="desc">Complete construction orders and researches in this village (doesn't work for Palace, Residence and WW).</td>
			<td class="dur">now</td>
			<td class="cost"><img src="img/x.gif" class="gold" alt="Gold" title="Gold" />1.99</td>
			<td class="act">
            	<span class="none">
					<?php
                        if (mysql_num_rows($MyGold)) {
		...
		<tr>
			...
			<td class="dur">now</td>
			<td class="cost"><img src="img/x.gif" class="gold" alt="Gold" title="Gold" />2.99</td>
			<td class="act">
                <span class="none">
                    <?php
                        if (mysql_num_rows($MyGold)) {
...
<table class="plusFunctions" cellpadding="1" cellspacing="1">
	<thead>
		<tr>
			<th colspan="5"><strike>Travian Gold club</strike> Don't Work</th>
		</tr>
		<tr>
            <td></td>
            <td>Description</td>
	...
	<tbody>
		<tr>
            ...
            <td class="cost"><img src="img/x.gif" class="gold" alt="Gold" title="Gold" />99.99</td>
            <td class="act">
            	<span class="none">
					<?php
                        if (mysql_num_rows($MyGold)) {
                            if($golds['gold'] > 99 && $golds['access'] > 4) {
                            echo '<a href="plus.php?id=7"><span><strike>Activate</strike>';
                        }elseif
                            ($datetimep > $date2) {
