...
##  Project:       ZravianX                                                    ##
##  Version:       2011.11.06                                                  ##
##  Filename:      Templates/Travian/3.6/tutorial.tpl                          ##
			...
			<div class="grit"> 
				<div class="grit"> 
					...
					<?php
						...
						$_GET['s'] = ""; }
						if ($_GET['s'] == "") {
						include("Templates/Travian/3.6/Tutorial/1.tpl"); }
						if ($_GET['s'] == "1") {
						include("Templates/Travian/3.6/Tutorial/1.tpl"); }
						if ($_GET['s'] == "2") {
						include("Templates/Travian/3.6/Tutorial/2.tpl"); }
						if ($_GET['s'] == "3") {
						include("Templates/Travian/3.6/Tutorial/3.tpl"); }
						if ($_GET['s'] == "4") {
						include("Templates/Travian/3.6/Tutorial/4.tpl"); }
						if ($_GET['s'] == "5") {
						include("Templates/Travian/3.6/Tutorial/5.tpl"); }
                    ?>
