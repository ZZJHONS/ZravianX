...
##  Project:       ZravianX                                                    ##
##  Version:       2011.11.26                                                  ##
##  Filename:      Templates/Build/4.tpl                                       ##
##  Improved by:   ZZJHONS                                                     ##
...
<div id="build" class="gid4">
	<a href="#" onClick="return Popup(4,4);" class="build_logo">
		<img class="building g4" src="img/x.gif" alt="<?php echo $lang['build4']; ?>" title="<?php echo $lang['build4']; ?>" />
	</a>
	<h1><?php echo $lang['build4']; ?> <span class="level"><?php echo $lang['level']." "; echo $village->resarray['f'.$id]; ?></span></h1>
	<p class="build_desc"><?php echo $lang['build4_desc']; ?></p>
