...
##  Project:       ZravianX                                                    ##
##  Version:       2011.11.07                                                  ##
##  Filename:      Templates/Profile/preference.tpl                            ##
...
<table cellpadding="1" cellspacing="1" id="time" class="set">
    ...
    <tbody>
            ...
            <td>
                <select name="timezone" class="dropdown">
					<optgroup label="local time zones">
                        <option value="495">Europe</option>
                        ...
                        <option value="474">New Zealand</option>
                    </optgroup>
        ...
        <tr>
            <th>Date</th>
            <td>
                <label><input class="radio" type="Radio" name="tformat" value="0"> EU (dd.mm.yy 24h)</label><br />
                <label><input class="radio" type="Radio" name="tformat" value="1"> US (mm/dd/yy 12h)</label><br />
                <label><input class="radio" type="Radio" name="tformat" value="2" checked> UK (dd/mm/yy 12h)</label><br />
                <label><input class="radio" type="Radio" name="tformat" value="3"> ISO (yy/mm/dd 24h)</label>
            </td>
        </tr>
    </tbody>
</table>
<p class="btn"><input type="image" value="" name="s1" id="btn_ok" class="dynamic_img" src="img/x.gif" alt="OK" /></p>
</form>
-->
<?php } ?>