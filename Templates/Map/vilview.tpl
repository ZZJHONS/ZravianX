...
<div id="content"  class="map">
	<?php $basearray = $database->getMInfo($_GET['d']); ?>
    ...
    <div id="map_details">
		...
		<?php } else if (!$basearray['occupied']) { ?>
            ...
            <tr>
                <td class="none">
                    <?php 
                        ...
                        } else if($village->unitarray['u'.$session->tribe.'0'] >= 3 AND !$enough_cp) {
                        ...
                        echo ($basearray['fieldtype']==0)?($village->resarray['f39']==0)?($basearray['owner'] == $session->uid)?
